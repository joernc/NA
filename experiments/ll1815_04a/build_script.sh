...
$MITGCMROOT/tools/genmake2 -mods=/central/groups/oceanphysics/anirban/NA/experiments/ll1815_04a/code/ -optfile=$MITGCMROOT/tools/build_options/linux_amd64_ifort+impi -mpi -rootdir=$MITGCMROOT
